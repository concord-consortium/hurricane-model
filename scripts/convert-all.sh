...
node scripts/convert-wind-data.js wind-data-netcdf/oct-u.nc wind-data-netcdf/oct-v.nc wind-data-json/oct-geojson.json geojson
...
node scripts/convert-wind-data.js wind-data-netcdf/oct-u.nc wind-data-netcdf/oct-v.nc wind-data-json/oct-simple.json simple
...
node --max-old-space-size=4092 scripts/convert-sea-surface-temp-to-png.js sea-surface-temp-netcdf/oct.nc sea-surface-temp-img/oct-default.png default
...
node --max-old-space-size=4092 scripts/convert-sea-surface-temp-to-png.js sea-surface-temp-netcdf/oct.nc sea-surface-temp-img/oct-purpleCC.png purpleCC
...
node --max-old-space-size=4092 scripts/convert-sea-surface-temp-to-png.js sea-surface-temp-netcdf/oct.nc sea-surface-temp-img/oct-purple3.png purple3
...
node --max-old-space-size=4092 scripts/convert-sea-surface-temp-to-png.js sea-surface-temp-netcdf/oct.nc sea-surface-temp-img/oct-rainbowCC.png rainbowCC
